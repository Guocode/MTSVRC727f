...
class MTSVRC:
    def __init__(self,data_path,label_train_file,label_val_file):
        ...
        self.label_val = self.load_label(label_val_file,shuffle=False)#("/media/guo/搬砖BOY/English/valEnglish.txt")#("D:/dataset/English/valEnglish.txt")
...
if __name__ == '__main__':
    ...
    mtsvrc.train(batch_size=1,filein_batch=8)
